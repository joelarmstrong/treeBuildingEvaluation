...
bin/getRegionAroundSampledColumn: src/getRegionAroundSampledColumn.cpp
	h5c++  -O3 -g -Wall -funroll-loops -DNDEBUG -I $(PROGRESSIVE_CACTUS_DIR)/submodules/sonLib/C/inc/ -I $(PROGRESSIVE_CACTUS_DIR)/submodules/hal/lib/ -o $@ $< $(PROGRESSIVE_CACTUS_DIR)/submodules/hal/lib/halLib.a $(PROGRESSIVE_CACTUS_DIR)/submodules/sonLib/lib/sonLib.a
